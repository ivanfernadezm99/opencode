...
- **`impeccable`** — the premium design-process skill in this library (craft, critique, polish, bolder, live browser iteration). **Default pairing in this setup:** pick a template here for the visual vocabulary, drive the workflow with `impeccable`.
